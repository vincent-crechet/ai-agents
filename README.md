...
### 1. Process File with AI
*Created: August 2024*

**Purpose**: Run the same prompt consistently on different input files (text, PDF).
...
**Purpose**: Generate professional HTML mockups for laboratory information technology applications using AI assistance.
